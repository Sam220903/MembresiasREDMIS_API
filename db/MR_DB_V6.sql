...
INSERT INTO MR_Miembros (nombre, apellidos, genero, codigo, verificado, MR_Universidades_id, MR_Estados_id, MR_Paises_id, MR_EstatusMiembros_id, MR_TiposUsuario_id) VALUES
    ('Juan', 'Pérez García', 'Masculino', 'ADM001', 1, 1, 1, 1, 1, 1),        -- Administrador
    ('María', 'López Martínez', 'Femenino', 'USR001', 1, 2, 2, 1, 1, 2),      -- Usuario Regular
    ('Robert', 'Smith Johnson', 'Masculino', 'USR002', 1, 3, 4, 2, 1, 2),     -- Usuario Regular
    ('Ana', 'García Rodríguez', 'Femenino', 'USR003', 1, 4, 5, 3, 1, 2),      -- Usuario Regular
    ('Carlos', 'Martínez López', 'Masculino', 'USR004', 1, 5, 6, 4, 1, 2);    -- Usuario Regular
